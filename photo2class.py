...
'''
эта функция выкачивает все фотографии пользователя по id, вызывает функцию class_of_photos для каждого блока и вконце возвращает словарь, ключи которого это классы, а значения это списки фотографий принадлежащие данному классу
'''
